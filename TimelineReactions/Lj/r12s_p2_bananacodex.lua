			...
			data = 
			{
				...
				conditions = 
				{
					
					{
						...
						{
							category = "Lua",
							conditionLua = "return not AnyoneCore.Settings.Reactions.m12sDNStaging",
